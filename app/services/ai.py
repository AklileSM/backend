                        ...
                        "content": [
                            {
                                ...
                                "text": (
                                    ...
                                    "**Quality Concerns:**\n"
                                    "(Provide 1-5 numbered items when there is anything visible that could be a quality/workmanship concern. "
                                    "If something is uncertain, still include it but label it \"Possible\" or \"Unclear from this image\". "
                                    "Only write exactly: \"1. None identified.\" if there truly are no quality concerns visible.)\n"
                                    "Use numbered items like:\n"
                                    "1. ...\n"
                                    "2. ...\n\n"
                                    "**Safety Concerns:**\n"
                                    "(Provide 1-5 numbered items when there is anything visible that could be a safety concern. "
                                    "If something is uncertain, still include it but label it \"Possible\" or \"Unclear from this image\". "
                                    "Only write exactly: \"1. None identified.\" if there truly are no safety concerns visible.)\n"
                                    "Use numbered items like:\n"
                                    "1. ...\n"
                                    "2. ...\n"
                                ),
